...
public class Warrior : Player
{
    ...
    protected override void CharacterCommonAttack()
    {
        ...
        if (inActive == false && Input.GetKeyDown(KeyCode.LeftControl))
        {
            ...
            attackTarget = Physics.OverlapSphere(transform.position, commonAttackRage, monsterLayer);
            ...
            if(Physics.Raycast(transform.position, transform.forward, out hit, commonAttackRage,
                monsterLayer))
            {
