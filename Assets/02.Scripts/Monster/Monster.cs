...
public partial class Monster : MonoBehaviour
{
    ...
    public float monsterMoveSpeed = 5f;     // 몬스터 이동 속도

    public float traceRange = 5f;   // 플레이어 캐릭터를 추격하는 범위
    public float attackRange = 1f;  // 플레이어 캐릭터에게 공격을 시도하는 범위
    public float attackDistance = 2f;   // 몬스터의 공격이 닿는 범위
    public float monsterCommonAttackCoolTime = 2.0f;    // 몬스터 일반공격 쿨타임
    public float monsterDamageDelay = 1f;

    public int monsterHP = 5;   // 몬스터의 체력
    public int monsterAP = 1;   // 몬스터의 공격력
